...
class PatchUtils {
    ...
    static void writeRef(final File file, final String ref) throws IOException {
    ...
    static void writeRefs(final File file, final List<String> refs) throws IOException {
        final OutputStream os = new FileOutputStream(file);
        try {
            writeRefs(os, refs);
            os.flush();
